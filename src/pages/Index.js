...
function Index() {
    ...
    const addToCart = (item) => {
        setCarts(prevCarts => {
            // ตรวจสอบว่า prevCarts เป็น array หรือไม่ ถ้าไม่เป็น ให้ใช้ array ว่างแทน
            const newCarts = Array.isArray(prevCarts) ? [...prevCarts, item] : [item];
            setRecordInCarts(newCarts.length);
            ...
            <MyModal id='modalCart' title='ตะกร้าสินค้าของฉัน'>
                    ...
                    <div className="mt-3">
                        <div className="alert alert-info">
                            <div>โปรดโอนเงินไปยังบันชี</div>
                            <div>ไทยพานิช จ้า ทดสอบ 888-000-88888</div>
                        </div>
                        <div>
                            <div>ชื่อผู้ซื้อ</div>
